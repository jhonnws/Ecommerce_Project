<div class="max-w-screen-xl mx-auto mt-10">
    <div>
        ...
        if ($this->session->flashdata('error') != '') {
            ...
            echo '<div id="alert-2" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50" role="alert">
    ...
    <div class="flex justify-center items-center">
        <div class="w-full max-w-xl">
            <div class="bg-slate-300 shadow-xl p-6 rounded-lg">
                <h2 class="text-center text-2xl font-semibold mb-6">Register</h2>

                <form action="<?= base_url("auth/register") ?>" method="POST">
                    <input type="text" name="firstname" placeholder="Firstname" class="w-full p-2 mb-4 border border-gray-300 rounded" required />

                    <input type="text" name="lastname" placeholder="Lastname" class="w-full p-2 mb-4 border border-gray-300 rounded" required />
                    ...
                    <input type="password" name="confirm_password" placeholder="Confirm Password" class="w-full p-2 mb-4 border border-gray-300 rounded" />
                ...
                <a href="<?= base_url('auth/login') ?>" class="block mt-4 text-center">
                    Click Here To Login
                </a>
            </div>
        </div>
