        ...
        <div class="w-full max-w-md ">
            ...
            <div class="bg-white shadow-lg p-6 rounded-lg">
                ...
                <form action="<?= base_url('auth/login'); ?>" method="POST">
                    <input name="email" type="text" placeholder="Email" class="w-full p-2 mb-4 border border-gray-300 rounded" required />

                    <input name="password" type="password" placeholder="Password" class="w-full p-2 mb-4 border border-gray-300 rounded" />
                ...
                <a href="<?= base_url('auth/register') ?>" class="block mt-4 text-center">
